  ...
  function open() {
    ...
    const sheet = h('div', { class: 'install-sheet' },
      ...
      h('footer', { class: 'install__foot' },
        ...
        h('p', { class: 'install__warn' }, 'لو ظهر «تعارض في التطبيق» أثناء التحديث: امسح النسخة القديمة الأول — النسخ المبنية تلقائيًا ليها توقيع تجريبي مختلف كل مرة (docs/06-install.md §6 يشرح تفعيل توقيع ثابت).'),
      ),
    );
  ...
  function showApkSteps(extra = '') {
    ...
    steps.append(
      ...
      h('ol', {},
        ...
        h('li', {}, 'اضغط ', h('b', {}, 'Run workflow'), ' على الفرع ', h('code', {}, 'main'), ' — البناء بياخد ~3 دقايق.'),
        h('li', {}, 'بعد ما يخلص، هيظهر ملف ', h('code', {}, 'nova-os-v…apk'), ' في صفحة ', h('b', {}, 'Releases'), ' — وده اللينك اللي الزر ده بيدوّر عليه أوتوماتيك.'),
